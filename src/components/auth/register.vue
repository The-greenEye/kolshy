      ...
      <div class="rounded p-2 bg-light form-sign">
        <div class="d-flex flex-column justify-content-center align-items-start">
          ...
          <div class="mt-4 d-flex justify-content-center align-items-center w-100">
            ...
            <router-link to="/register-seller" style="color: #e51742; text-decoration: underline; font-weight: 600">Sign up</router-link>
          </div>
    ...
    async submitOtp() {
      ...
      try {
        const verificationResponse = await axios.post(
          ...
          {
            headers: {
              Authorization: `Bearer ${localStorage.tokenkolshy}`,
            },
          }
        );
