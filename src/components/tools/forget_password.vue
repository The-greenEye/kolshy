        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <form method="post" class="w-100 p-0" @submit.prevent="submitForm()">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center mb-4 mt-4">
              <button type="submit" class="btn rounded-3 d-flex justify-content-center align-items-center w-100 mb-2" style="background-color: #e51742; color: var(--text-color-secondary); font-weight: 700; font-size: 20px" :disabled="isSubmitting">
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        const response = await axios.post("https://back.kolshy.ae/api/auth/forgot-password/send-otp", { email_or_phone: this.email });
    ...
    async submitOtp() {
      ...
      try {
        const response = await axios.post(
          "https://back.kolshy.ae/api/auth/forgot-password/verify-otp",
          {
    ...
    async resendOtp() {
      try {
        await axios.post("https://back.kolshy.ae/api/auth/forgot-password/send-otp", { email_or_phone: this.email });
    ...
    async resetPass() {
      ...
      try {
        const response = await axios.post("https://back.kolshy.ae/api/auth/forgot-password/reset-password", {
